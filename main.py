...
class MenuScreen(Screen):
    def __init__(self, **kw):
        ...
        box.add_widget(Button(text='What i need to do today', on_press=lambda x:
                              set_screen('list_food')))
        box.add_widget(Button(text='Add Activity',
...
#For debug - show version of python with info about fast compile in docker
    ...
    def __init__(self, **kw):
        ...
        self.txt1 = TextInput(text='', multiline=False, height=dp(40),
                              size_hint_y=None, hint_text="Name of activity")
        box.add_widget(self.txt1)
        btn1 = Button(text="Add activity", size_hint_y=None, height=dp(40))
